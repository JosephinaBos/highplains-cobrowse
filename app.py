...
@route("/")
def hello_world():
    return static_file('highplains.html', root=static_path)

@route("/dXEziihYnbDGaVwzQyHu")
def serve_form():
...
def join_session():
    ...
    if security != "dXEziihYnbDGaVwzQyHu":
        return abort(403, "Forbidden")
    r = requests.get('https://api.surfly.com/v2/sessions/?api_key=fcfb9c29c99b444dbaa322392030ed23&active_session=true')
